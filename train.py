...
def main(data_dir: str):
    ...
    train_dfs = LSTM.stocks_data(train_files, dates=dates, img_dir="./train_results")
    test_dfs = LSTM.stocks_data(test_files, dates=dates, img_dir="./train_results")
    ...
    for file_index in range(len(train_files)):
        ...
        model = LSTM(hidden_dim=64, input_dim=2, num_layers=2, out_dim=1)
        ...
        y_train_pred, y_test_pred = model.predict(data_tensors=data_tensors, stock_name=file_name, df=combined_df)
